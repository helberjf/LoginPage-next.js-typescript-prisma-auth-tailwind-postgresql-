  ...
  return (
    <aside className="w-64 p-6 border-r border-neutral-200 dark:border-neutral-800 hidden md:block bg-white dark:bg-neutral-900">
      ...
      <nav className="flex flex-col text-sm gap-2">
        <a href="/dashboard" className="flex items-center gap-2 px-3 py-2 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800">
          <Home size={16} /> <span>Home</span>
        </a>
        <a href="/test-env" className="flex items-center gap-2 px-3 py-2 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800">
          <Layers size={16} /> <span>Test Environment</span>
        </a>
        <a href="/admin/products" className="flex items-center gap-2 px-3 py-2 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800">
          <Box size={16} /> <span>Products</span>
        </a>
        <a href="/app/api/users" className="flex items-center gap-2 px-3 py-2 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800 opacity-70">
